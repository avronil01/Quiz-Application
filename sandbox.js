...
const questions = [
    ...
    {
        title : '2. Which of the following are components of Central Processing Unit (CPU) ?',
        options : [
    ...
    {
        title : '3. Which among following first generation of computers had ?',
        options : [
    ...
    {
        title : '5. If a computer has more than one processor then it is known as ?',
        options : [
            'Uniprocess',
            'Multiprocessor',
            'Multithreaded',
    ...
    {
        title : '6. If a computer provides database services to other, then it will be known as ?',
        options : [
            'Web server',
            'Application server',
            'Database server',
    ...
    {
        title : '8. In which of the following form, data is stored in computer ?',
        options : [
            'Decimal',
            'Binary',
            'HexaDecimal',
    ...
    {
        title : '9. Which level language is Assembly Language ?',
        options : [
    ...
    {
        title : '10. Documents, Movies, Images and Photographs etc are stored at a ?',
        options : [
            'Application Sever',
            'Web Sever',
            'Print Server',
